...
document.addEventListener("DOMContentLoaded", () => { // load script only when website is loaded
  ...
  document.getElementById('next').onclick = () => moveSlide(index + 1); // move to next slide
  document.getElementById('prev').onclick = () => moveSlide(index - 1); // move to previous slide
